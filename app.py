...
def show_welcome_page():
    ...
    render_instructions_expander(
                                    "welcome",
                                    likert_count=len(load_likert_trials(LIKERT_TRIALS_XLSX)),
                                    pairwise_count=len(load_pairwise_trials(PAIRWISE_TRIALS_XLSX)),
                                )
...
def show_likert_page():
    ...
    render_instructions_expander("likert", likert_count=len(likert_df))
    ...
    for idx, row in likert_df.iterrows():
        ...
        with st.expander(expander_title, expanded=True):
            ...
            with left_col:
                ...
                audio_details = f"First 10 seconds is the original concert audio of the musicians, and the next 10 seconds is the AI generated continuation."
...
def show_pairwise_page():
    ...
    render_instructions_expander("pairwise", pairwise_count=len(pairwise_df))
